    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
          ...
          .authorizeHttpRequests(req -> req
            .requestMatchers("/api/v1/auth/**", "/swagger-ui/**", "/v3/api-docs/**", "/api/password-recovery", "/api/v1/t/test-email", "/api/reservations/**", "/api/timeslots/**",
                    "/api/reservations/gimnasio/**").permitAll()
